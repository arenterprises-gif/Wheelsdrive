        ...
        <Routes>
          ...
          <Route path="*" element={
            <div style={{ background:'#F8F9FC',minHeight:'100vh',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',gap:16 }}>
              ...
              <div style={{ fontFamily:'Syne,sans-serif',fontWeight:800,fontSize:28,color:'#1A1A2E' }}>Page Not Found</div>
              <a href="/" style={{ color:'#FF6B00',fontSize:15 }}>← Back to WheelsDrive</a>
            </div>
          }/>
        </Routes>
      </BrowserRouter>
