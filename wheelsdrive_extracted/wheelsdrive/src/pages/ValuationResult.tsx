...
const ScoreBar = ({ label, score, color='#FF6B00' }: { label:string; score:number; color?:string }) => (
      ...
      <div style={{ paddingTop:64 }}>
        ...
        <div style={{ background:'linear-gradient(135deg,#1A1A2E,#2D2D4E)',color:'#fff',padding:'48px 24px',textAlign:'center' }}>
          <div style={{ maxWidth:600,margin:'0 auto' }}>
            <div style={{ background:'rgba(255,107,0,0.2)',border:'1px solid rgba(255,107,0,0.4)',display:'inline-block',borderRadius:20,padding:'4px 14px',fontSize:12,fontWeight:700,letterSpacing:2,marginBottom:16,color:'#FF6B00' }}>
            ...
            <div style={{ display:'flex',alignItems:'center',justifyContent:'center',gap:12,marginBottom:8 }}>
              <span style={{ fontFamily:'Syne,sans-serif',fontWeight:800,fontSize:'clamp(28px,6vw,52px)',color:'#FF6B00' }}>
                {fmt(r.estimated_min)}
              </span>
            ...
            <div style={{ background:'rgba(255,107,0,0.15)',borderRadius:12,padding:'10px 20px',display:'inline-block',marginBottom:28 }}>
              ...
              <span style={{ color:'#FF6B00',fontWeight:800,fontSize:20,fontFamily:'Syne,sans-serif' }}>{r.scores.overall_score}/100</span>
            </div>
            ...
            <div style={{ display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:12 }}>
              {[
                ...
                { label:'Best Price', price:r.recommended_price, desc:'Ideal market price', color:'#FF6B00', highlight:true },
                ...
                <div key={p.label} style={{ background:p.highlight?'rgba(255,107,0,0.15)':'rgba(255,255,255,0.05)', border:`1px solid ${p.highlight?'rgba(255,107,0,0.4)':'rgba(255,255,255,0.1)'}`, borderRadius:12, padding:'14px 10px', textAlign:'center' }}>
                  ...
                  <div style={{ color:'#fff',fontFamily:'Syne,sans-serif',fontWeight:800,fontSize:'clamp(14px,2.5vw,22px)' }}>{fmt(p.price)}</div>
        ...
        <div style={{ maxWidth:800,margin:'0 auto',padding:'32px 16px' }}>
          <div style={{ display:'grid',gridTemplateColumns:'1fr 1fr',gap:20,marginBottom:20 }}>
            ...
            <div style={{ background:'#fff',borderRadius:16,padding:22,border:'1px solid #E8ECF0',boxShadow:'0 2px 8px rgba(0,0,0,0.05)' }}>
              <h3 style={{ fontFamily:'Syne,sans-serif',fontWeight:800,fontSize:17,color:'#1A1A2E',marginBottom:20 }}>Score Breakdown</h3>
            ...
            {/* Car summary */}
            <div style={{ background:'#fff',borderRadius:16,padding:22,border:'1px solid #E8ECF0',boxShadow:'0 2px 8px rgba(0,0,0,0.05)' }}>
              <h3 style={{ fontFamily:'Syne,sans-serif',fontWeight:800,fontSize:17,color:'#1A1A2E',marginBottom:20 }}>Car Details</h3>
              {[
          ...
          <div style={{ background:'#fff',borderRadius:16,padding:22,border:'1px solid #E8ECF0',boxShadow:'0 2px 8px rgba(0,0,0,0.05)',marginBottom:20 }}>
            <h3 style={{ fontFamily:'Syne,sans-serif',fontWeight:800,fontSize:17,color:'#1A1A2E',marginBottom:20 }}>Valuation Breakdown</h3>
          ...
          {/* CTA */}
          <div style={{ background:'linear-gradient(135deg,#FFF3E8,#FFE8D0)',borderRadius:16,padding:24,border:'1px solid #FFD5B0',textAlign:'center',marginBottom:20 }}>
            <h3 style={{ fontFamily:'Syne,sans-serif',fontWeight:800,fontSize:20,color:'#1A1A2E',marginBottom:8 }}>Ready to Sell?</h3>
            ...
            <div style={{ display:'flex',gap:12,justifyContent:'center',flexWrap:'wrap' }}>
              ...
              <button onClick={()=>nav('/sell')} style={{ background:'#fff',border:'1.5px solid #E8ECF0',color:'#64748B',borderRadius:10,padding:'12px 20px',cursor:'pointer',fontWeight:600,fontSize:14,display:'flex',alignItems:'center',gap:8,fontFamily:'DM Sans,sans-serif' }}>
