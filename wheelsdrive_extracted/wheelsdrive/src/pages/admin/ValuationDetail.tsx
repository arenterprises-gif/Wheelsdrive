  ...
  return (
    <div style={{ maxWidth:900,margin:'0 auto' }}>
      <div style={{ display:'flex',alignItems:'center',gap:16,marginBottom:24 }}>
        <button onClick={()=>nav('/admin/valuations')} style={{ background:'none',border:'1px solid #E8ECF0',color:'#64748B',borderRadius:8,padding:'8px 14px',cursor:'pointer',display:'flex',alignItems:'center',gap:6,fontSize:13,fontFamily:'DM Sans,sans-serif' }}>
          <ChevronLeft size={14}/> Back
        </button>
        <h1 style={{ fontFamily:'Syne,sans-serif',fontWeight:800,fontSize:22,color:'#1A1A2E' }}>
      ...
      <div style={{ display:'grid',gridTemplateColumns:'1fr 1fr',gap:20,marginBottom:20 }}>
        ...
        <div className="card" style={{ padding:20 }}>
          <h3 style={{ fontFamily:'Syne,sans-serif',fontWeight:700,fontSize:16,color:'#1A1A2E',marginBottom:16 }}>AI Valuation</h3>
          <div style={{ background:'linear-gradient(135deg,#FF6B00,#E55A00)',borderRadius:12,padding:16,textAlign:'center',marginBottom:14,color:'#fff' }}>
            <div style={{ fontSize:12,opacity:0.8,marginBottom:4 }}>Estimated Range</div>
            <div style={{ fontFamily:'Syne,sans-serif',fontWeight:800,fontSize:22 }}>{fmt(r.estimated_min)} — {fmt(r.estimated_max)}</div>
          </div>
          ...
          <div style={{ marginTop:14 }}>
            ...
            {val.admin_override_price&&<div style={{ color:'#FF6B00',fontSize:12,marginTop:4 }}>Current override: {fmt(val.admin_override_price)}</div>}
          </div>
        </div>
        ...
        <div style={{ display:'flex',flexDirection:'column',gap:14 }}>
          <div className="card" style={{ padding:20 }}>
            <h3 style={{ fontFamily:'Syne,sans-serif',fontWeight:700,fontSize:16,color:'#1A1A2E',marginBottom:14 }}>Customer</h3>
          ...
          <div className="card" style={{ padding:20 }}>
            <h3 style={{ fontFamily:'Syne,sans-serif',fontWeight:700,fontSize:16,color:'#1A1A2E',marginBottom:14 }}>Car Details</h3>
      ...
      {Object.keys(val.images||{}).filter(k=>k!=='damage').length>0&&(
        <div className="card" style={{ padding:20,marginBottom:20 }}>
          <h3 style={{ fontFamily:'Syne,sans-serif',fontWeight:700,fontSize:16,color:'#1A1A2E',marginBottom:16 }}>Uploaded Photos</h3>
      ...
      {/* Admin controls */}
      <div className="card" style={{ padding:20,marginBottom:20 }}>
        <h3 style={{ fontFamily:'Syne,sans-serif',fontWeight:700,fontSize:16,color:'#1A1A2E',marginBottom:16 }}>Admin Actions</h3>
