      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24, flexWrap: 'wrap', gap: 12 }}>
        <div>
          ...
          <p style={{ color: '#9CA3AF', fontSize: 13, fontWeight: 500 }}>
            <span style={{ fontWeight: 700, color: '#0052CC' }}>{valuations?.length || 0}</span> total requests
          </p>
        </div>
        <select
          value={statusFilter}
          ...
          {filtered.map((val, i) => {
            ...
            return (
              <div
                ...
                <div style={{ fontFamily: 'Nunito,sans-serif', fontWeight: 900, fontSize: 15, color: '#0052CC' }}>
                ...
                <button
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.background = '#EBF2FF'; (e.currentTarget as HTMLButtonElement).style.color = '#0052CC'; (e.currentTarget as HTMLButtonElement).style.borderColor = '#B3D1FF'; }}
