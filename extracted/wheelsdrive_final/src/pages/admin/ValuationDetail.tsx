    ...
    <div style={{ maxWidth:900,margin:'0 auto' }}>
      ...
      <div style={{ display:'grid',gridTemplateColumns:'1fr 1fr',gap:20,marginBottom:20 }}>
        ...
        <div className="card" style={{ padding:20 }}>
          ...
          <div style={{ background:'linear-gradient(135deg,#0052CC,#003D99)',borderRadius:12,padding:16,textAlign:'center',marginBottom:14,color:'#fff' }}>
          ...
          <div style={{ marginTop:14 }}>
            ...
            {val.admin_override_price&&<div style={{ color:'#0052CC',fontSize:12,marginTop:4 }}>Current override: {fmt(val.admin_override_price)}</div>}
          </div>
        </div>
