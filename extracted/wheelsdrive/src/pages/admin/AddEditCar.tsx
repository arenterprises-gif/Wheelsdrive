    ...
    <div style={{ maxWidth: 880, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div style={cardStyle}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {[
                { key: 'is_hot_deal', label: '🔥 Mark as Hot Deal', desc: 'Shows in Hot Deals section on homepage', color: '#E8520A' },
              ...
              {FEATURES_LIST.map(f => {
                ...
                return (
                  <button key={f} onClick={() => toggleFeature(f)}
                    style={{
                      background: on ? '#FFF5F0' : '#F9FAFB',
                      border: `1.5px solid ${on ? '#E8520A' : '#E5E7EB'}`,
                      color: on ? '#E8520A' : '#6B7280',
      ...
      <div style={{
        ...
        <button onClick={handleSave} disabled={saveMutation.isPending}
          style={{
            background: saveMutation.isPending ? '#9CA3AF' : 'linear-gradient(135deg,#E8520A,#FF6B2B)',
            ...
            boxShadow: saveMutation.isPending ? 'none' : '0 4px 14px rgba(232,82,10,0.3)',
            transition: 'all 0.18s',
          }}>
