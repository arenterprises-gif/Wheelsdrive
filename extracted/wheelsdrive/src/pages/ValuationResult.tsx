...
const ScoreBar = ({ label, score, color='#E8520A' }: { label:string; score:number; color?:string }) => (
      ...
      <div style={{ paddingTop:64 }}>
        ...
        <div style={{ background:'linear-gradient(135deg,#1A1A2E,#2D2D4E)',color:'#fff',padding:'48px 24px',textAlign:'center' }}>
          <div style={{ maxWidth:600,margin:'0 auto' }}>
            <div style={{ background:'rgba(255,107,0,0.2)',border:'1px solid rgba(255,107,0,0.4)',display:'inline-block',borderRadius:20,padding:'4px 14px',fontSize:12,fontWeight:700,letterSpacing:2,marginBottom:16,color:'#E8520A' }}>
            ...
            <div style={{ display:'flex',alignItems:'center',justifyContent:'center',gap:12,marginBottom:8 }}>
              <span style={{ fontFamily:'Nunito,sans-serif',fontWeight:800,fontSize:'clamp(28px,6vw,52px)',color:'#E8520A' }}>
                {fmt(r.estimated_min)}
              </span>
            ...
            <div style={{ background:'rgba(255,107,0,0.15)',borderRadius:12,padding:'10px 20px',display:'inline-block',marginBottom:28 }}>
              ...
              <span style={{ color:'#E8520A',fontWeight:800,fontSize:20,fontFamily:'Nunito,sans-serif' }}>{r.scores.overall_score}/100</span>
            </div>
            ...
            <div style={{ display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:12 }}>
              {[
                ...
                { label:'Best Price', price:r.recommended_price, desc:'Ideal market price', color:'#E8520A', highlight:true },
